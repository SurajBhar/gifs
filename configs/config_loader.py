...
def config_parser():
    ...
    parser.add_argument(
        "--split_file", type=str, help='Path to read and write the data split file. Needs to end with ".npz"'
    )
    ...
    parser.add_argument(
        "--num_points", type=int, default=10000, help="Number of points sampled from each ground truth shape."
    )
    ...
    parser.add_argument("--lr", type=float, default=1e-6, help="Learning rate used during training.")
